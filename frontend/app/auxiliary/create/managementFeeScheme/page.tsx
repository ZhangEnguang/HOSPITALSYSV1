...
import FeeItemsForm from "./components/fee-items-form"
import CompletionStep from "./components/completion-step"

export default function CreateManagementFeeSchemeePage() {
  ...
  const handleComplete = () => {
    console.log("提交管理费提取方案", formData)
    // 实现提交逻辑
  ...
  return (
    <div className="w-full py-6 min-h-screen">
      <div className="flex items-center px-8 mb-6">
        ...
        <h1 className="text-2xl font-bold">新增管理费提取方案</h1>
      </div>
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              管理费提取方案已成功创建，您可以继续添加新的管理费提取方案或返回列表查看。
            </DialogDescription>
          </DialogHeader>

      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="category" className="text-sm font-medium flex items-center">
            报销类别 <span className="text-red-500 ml-1">*</span>
          </Label>
          <Select 
          ...
          >
            <SelectTrigger 
              className={cn(
                "h-10", 
                validationErrors["报销类别"] && "border-red-500 focus-visible:ring-red-500"
              )}
            >
          ...
          {validationErrors["报销类别"] && (
            <p className="text-sm text-red-500 mt-1">请选择报销类别</p>
          )}
        </div>
      </div>
    </div>

...
interface ApplicationBatchTableProps {
...
export const ApplicationBatchTable: React.FC<ApplicationBatchTableProps> = ({
  items,
  batchProjects,
  expandedBatches,
  onToggleBatchExpand,
  ...
  const canTransferToReview = (item: ApplicationItem) => {
    ...
    return now > endDate && item.batch === "申报批次";
  };
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50">
                ...
                <TableHead className="font-medium">申报批次名称</TableHead>
                <TableHead className="font-medium">申报类型</TableHead>
                <TableHead className="font-medium">申报类别</TableHead>
                <TableHead className="font-medium">申报状态</TableHead>
                <TableHead className="font-medium">申报总金额（万元）</TableHead>
                ...
                <TableHead className="font-medium">申报数量</TableHead>
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {canTransferToReview(item) && (
                            <DropdownMenuItem onClick={() => onTransferToReview(item)}>
                            ...
                            <TableBody>
                              {batchProjects[item.id]?.map((project) => (
                                <TableRow key={project.id}>
                                  ...
                                  <TableCell>{project.manager.title}</TableCell>
                                  ...
                                  <TableCell>
                                    <Badge variant={applicationStatusColors[project.status]}>{project.status}</Badge>
                                  </TableCell>
                                  <TableCell className="text-right">
                                    <DropdownMenu>
                                      <DropdownMenuTrigger asChild>
...
export default ApplicationBatchTable; 
  ...
  return (
    <div className="flex-1 overflow-auto bg-white">
      ...
      <table className="w-full border-collapse table-fixed">
        ...
        <thead>
          <tr>
            <th className="border-r border-b p-2 text-center text-sm text-muted-foreground">GMT+07</th>
        ...
        <tbody>
          {hours.map((hour) => (
            <tr key={hour}>
              <td className="border-r border-b p-2 text-right text-sm text-muted-foreground">

...
const DEFAULT_PROJECT_DATA = {
  projectTitle: "人类遗传资源对外提供研究项目",
  projectSource: "院内立项",
  researchUnit: "生物医学研究中心",
  projectType: "人类遗传资源对外提供或开放使用",
  leaderName: "张教授",
  department: "基础医学院",
...
// 人体伦理对外提供或开放使用备案组件
export function HumanGeneticExternalUseReview({
  ...
  const handleSubmit = (data: any) => {
    console.log("提交人体伦理对外提供或开放使用备案表单:", data)
    toast({
      title: "提交成功",
      description: "人体伦理对外提供或开放使用备案表单已提交成功"
    })
  }

  return (
    <ReviewFormBase
      title="新建人体伦理对外提供或开放使用备案"

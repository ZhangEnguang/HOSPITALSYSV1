...
// 人体伦理人遗采集审批组件
export function HumanGeneticCollectionReview({
  ...
  const initialReviewFiles: ReviewFileItem[] = [
    {
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/human-genetic-collection-application.docx"
    },
    {
      id: 2,
      fileName: "人类遗传资源采集方案",
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/human-genetic-collection-protocol.docx"
    },
    {
      id: 3,
      fileName: "知情同意书",
    ...
    },
    {
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/privacy-protection-measures.docx"
    },
    {
      id: 5,
      fileName: "伦理审查通过证明",
  ...
  const handleSubmit = (data: any) => {
    console.log("提交人体伦理人遗采集审批表单:", data)
    toast({
      title: "提交成功",
      description: "人体伦理人遗采集审批表单已提交成功"
    })
  }

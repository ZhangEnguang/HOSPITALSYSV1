...
const DEFAULT_PROJECT_DATA = {
  projectTitle: "多中心国际合作临床试验",
  projectSource: "国际合作项目",
  researchUnit: "临床医学研究中心",
  projectType: "人体国际合作临床试验",
  leaderName: "王教授",
  department: "临床医学院",
  ethicsCommittee: "临床医学伦理委员会"
}

// 人体伦理国际合作临床试验备案组件
export function HumanGeneticInternationalClinicalReview({
  ...
  const handleSubmit = (data: any) => {
    console.log("提交人体伦理国际合作临床试验备案表单:", data)
    toast({
      title: "提交成功",
      description: "人体伦理国际合作临床试验备案表单已提交成功"
    })
  }

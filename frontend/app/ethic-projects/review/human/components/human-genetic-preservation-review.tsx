...
// 人体伦理人遗保藏审批组件
export function HumanGeneticPreservationReview({
  ...
  const initialReviewFiles: ReviewFileItem[] = [
    {
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/human-genetic-preservation-application.docx"
    },
    {
      id: 2,
      fileName: "人类遗传资源保藏方案",
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/human-genetic-preservation-protocol.docx"
    },
    {
      id: 3,
      fileName: "保藏设施与条件说明",
    ...
    },
    {
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/biosafety-measures.docx"
    },
    {
      id: 5,
      fileName: "知情同意书",
  ...
  const handleSubmit = (data: any) => {
    console.log("提交人体伦理人遗保藏审批表单:", data)
    toast({
      title: "提交成功",
      description: "人体伦理人遗保藏审批表单已提交成功"
    })
  }

...
// 人体伦理材料出境审批组件
export function HumanGeneticExportReview({
  ...
  const initialReviewFiles: ReviewFileItem[] = [
    {
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/genetic-material-export-application.docx"
    },
    {
      id: 2,
      fileName: "材料出境说明",
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/material-export-explanation.docx"
    },
    {
      id: 3,
      fileName: "材料清单及数量",
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/export-material-list.xlsx"
    },
    {
      id: 4,
      fileName: "国际合作协议",
    ...
    },
    {
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/transportation-plan.docx"
    },
    {
      id: 7,
      fileName: "伦理审查通过证明",
  ...
  const handleSubmit = (data: any) => {
    console.log("提交人体伦理材料出境审批表单:", data)
    toast({
      title: "提交成功",
      description: "人体伦理材料出境审批表单已提交成功"
    })
  }

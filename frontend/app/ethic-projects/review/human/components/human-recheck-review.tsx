...
export function HumanRecheckReview({
  ...
  const recheckReviewFiles: ReviewFileItem[] = [
    ...
    },
    {
      ...
      versionNumber: "",
      hasTemplate: true,
      templateUrl: "/templates/safety-update-report.docx"
    },
    {
      id: 8,
      fileName: "其他支持性文件",
  ...
  // 管理送审文件清单状态
  const [reviewFiles, setReviewFiles] = useState<ReviewFileItem[]>(recheckReviewFiles)
  ...
  const startAIReview = async () => {
    ...
    // 构建审查文件列表
    const reviewFileList = [...recheckReviewFiles].map(file => {
  ...
  const resetForm = () => {
    // 重置文件列表
    setReviewFiles(recheckReviewFiles);
    setFilesMap(new Map());
    ...
    <div className="w-full pb-6 px-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold">新增复审</h1>
          {isPanelCollapsed && (
  ...
  // 渲染主界面
  return (
    <div className="human-ethics-recheck-review-container w-full">

...
const reviewTypes = [
  {
    id: "initial",
    name: "初始审查",
    description: "首次申请审查，包含项目申请表、研究方案等基础文件",
  ...
  },
  {
    id: "amendment",
    name: "变更审查", 
    description: "研究方案变更审查，包含变更申请、调整说明等文件",
...
const fileTypeConfig = {
  ...
  consent: { label: "知情同意", icon: <FileText className="h-4 w-4" /> },
  welfare: { label: "知情同意", icon: <FileText className="h-4 w-4" /> },
...
const mockReviewFiles = [
  {
    ...
    description: "标准人体伦理委员会申请表"
  },
  {
    id: "2", 
    reviewType: "initial",
    fileName: "临床研究方案.docx",
    fileType: "protocol",
    uploadDate: "2024-01-15",
    uploadUser: "王教授",
    fileSize: "5.7MB",
    status: "approved",
    version: "1.0",
    reviewComments: "研究方案设计合理，符合人体伦理要求",
    reviewDate: "2024-01-20",
    description: "详细临床研究流程及受试者管理计划"
  },
  {
    id: "3",
    reviewType: "initial", 
    ...
    status: "approved", 
    version: "1.0",
    reviewComments: "知情同意书内容详尽，保护措施完善",
    reviewDate: "2024-01-21",
    description: "受试者知情同意书及权益保护措施"
  },
  {
    id: "4",
    reviewType: "initial",
    ...
    reviewDate: "2024-01-21",
    description: "研究人员培训合格证书及资质材料"
  },
  {
    id: "5",
    reviewType: "amendment",
    fileName: "研究方案变更申请.pdf",
    fileType: "amendment",
    ...
    reviewComments: "",
    reviewDate: "",
    description: "受试者招募标准及研究流程变更申请"
  },
  {
    id: "6",
    reviewType: "amendment",
    fileName: "受试者数量调整说明.docx",
    fileType: "adjustment",
    uploadDate: "2024-03-10",
    uploadUser: "王教授",
    fileSize: "1.5MB", 
  ...
  },
  {
    ...
    status: "rejected",
    version: "1.0", 
    reviewComments: "报告内容不够详细，需要补充受试者安全性数据分析",
    reviewDate: "2024-12-05",
    description: "年度研究进展及受试者管理情况报告"
  },
  {
    id: "9",
    reviewType: "annual",

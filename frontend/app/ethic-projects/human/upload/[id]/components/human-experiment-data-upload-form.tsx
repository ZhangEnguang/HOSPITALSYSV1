...
interface HumanExperimentDataUploadFormProps {
  projectId: string
}

// 人体伦理实验数据上传表单组件
export function HumanExperimentDataUploadForm({ projectId }: HumanExperimentDataUploadFormProps) {
      ...
      <Dialog open={showCompletionDialog} onOpenChange={setShowCompletionDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="sm:justify-center">
            <Button 
              variant="outline" 
              onClick={() => router.push(`/ethic-projects/human/${projectId}`)}
            >
              返回项目详情
            </Button>
            <Button 

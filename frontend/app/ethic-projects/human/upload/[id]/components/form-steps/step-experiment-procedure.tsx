    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label htmlFor="interventionDetails" className="text-sm font-medium">
              干预措施详情
            </Label>
            <Textarea
              id="interventionDetails"
              name="interventionDetails"
              placeholder="请详细描述干预措施的具体实施方法和过程"
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="请输入实验持续时间，如：3小时、4周等"

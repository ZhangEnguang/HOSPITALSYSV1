...
export const mockEthicProjects = [
  {
    ...
    name: "转基因小鼠模型对阿尔茨海默症疗效研究",
    description: "利用转基因小鼠模型研究新型药物对阿尔茨海默症的临床前疗效评估",
    status: "进行中",
    auditStatus: "审核通过",
    priority: "高",
    type: "动物伦理",

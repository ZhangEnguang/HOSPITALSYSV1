...
export default function CageBookingViewPage() {
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                  <div className="flex flex-col items-center">
                    <p className="text-sm text-gray-500 mb-2">开始日期</p>
                    ...
                    <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-900">{booking.processor.name}</p>
                          <p className="text-xs text-gray-500">{booking.processor.role}</p>
                        </div>
                        <div>
                      ...
                      {booking.approvalComments && (
                        <div className="mt-3">
                          ...
                          <p className="text-sm text-gray-900 mt-1">{booking.approvalComments}</p>
                        </div>
                      )}
                    </div>
                  )}

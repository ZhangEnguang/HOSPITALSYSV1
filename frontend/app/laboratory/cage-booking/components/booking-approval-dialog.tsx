          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4 pl-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-semibold text-gray-900">{booking.cageLocation}</h4>
                    <p className="text-sm text-gray-500 mt-1">{booking.cageType}</p>
                  </div>
                </div>
                
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">笼位编号</label>
                    <p className="text-sm font-medium text-gray-700">{booking.cageId}</p>
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">笼位类型</label>
                    <p className="text-sm font-medium text-gray-700">{booking.cageType}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 pb-6 border-b border-gray-100">
              ...
              <div className="space-y-4 pl-3">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">动物种类</label>
                    <p className="text-sm font-medium text-gray-700">{booking.animalSpecies}</p>
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">品系与级别</label>
                    <p className="text-sm font-medium text-gray-700">{booking.animalStrain}</p>
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">动物年龄</label>
                    <p className="text-sm font-medium text-gray-700">{booking.animalAge || "未提供"}</p>
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">动物数量</label>
                    <p className="text-sm font-medium text-gray-700 flex items-center gap-1">
                      <Users className="h-3 w-3" />
                      {booking.animalCount}只
                    </p>
                  </div>
                </div>
                ...
                {/* 性别比例 - 占整行 */}
                <div className="space-y-1">
                  <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">性别比例</label>
                  <p className="text-sm font-medium text-gray-700">{booking.genderRatio || "未提供"}</p>
                </div>
              </div>
            </div>

...
interface ReagentApplicationViewDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  application: any
}

export function ReagentApplicationViewDialog({ 
  open, 
  onOpenChange, 
  application 
}: ReagentApplicationViewDialogProps) {
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm pt-2 border-t">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{application.specification || "Pure 200级"}</span>
                  </div>
                </div>
              </div>
            </div>

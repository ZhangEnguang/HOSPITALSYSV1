              ...
              <div className="space-y-4 pl-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-semibold text-gray-900">{application.consumableName}</h4>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wide">耗材类型</label>
                    <p className="text-sm font-medium text-gray-700">{application.consumableType}</p>
                  </div>
                  <div className="space-y-1">

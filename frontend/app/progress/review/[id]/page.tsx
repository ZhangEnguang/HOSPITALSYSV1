...
// 导入标签页组件
import ProgressOverviewTab from "../../[id]/components/progress-overview-tab"
import ProgressDocumentsTab from "../../[id]/components/progress-documents-tab"
import ProgressRelatedProjectsTab from "../../[id]/components/progress-related-projects-tab"

// 导入示例数据
import { projectChangeItems } from "../../data/progress-demo-data"

export default function ProgressReviewPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex flex-col relative">
      ...
      <ReviewSidebar projectData={progress} />
    </div>
  )
}

...
// 导入标签页组件
import ContractOverviewTab from "../../[id]/components/contract-overview-tab"
import ContractDocumentsTab from "../../[id]/components/contract-documents-tab"
import ContractRelatedProjectsTab from "../../[id]/components/contract-related-projects-tab"
import ContractProcessTab from "../../[id]/components/contract-process-tab"
import ContractFundsTab from "../../[id]/components/contract-funds-tab"
import ContractAchievementsTab from "../../[id]/components/contract-achievements-tab"
...
export default function ContractReviewPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex flex-col relative">
      ...
      <ReviewSidebar projectData={contract} />
    </div>
  )
}

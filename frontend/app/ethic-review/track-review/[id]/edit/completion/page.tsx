...
// 研究完成审查编辑页面
export default function EditCompletionReviewPage() {
  ...
  const completionReviewFiles: ReviewFileItem[] = [
    ...
    },
    {
      ...
      files: [
        {
          name: "伦理批准文件-2022-11-15.pdf",
          uploadedAt: "2024-03-05",
          size: 1.1,
          status: "已上传"
        }
      ],
      versionDate: "2022-11-15",
      versionNumber: "",
      hasTemplate: false,
      templateUrl: ""
    },
  ...
  const handleSubmit = (data: any) => {
    console.log("提交研究完成审查表单:", data)
    toast({
      title: "提交成功",
      description: "研究完成审查表单已成功更新"
    })

...
const mockReviewProjects = [
  ...
  },
  {
    ...
    reviewNumber: "ETH-TRK-2024-001",
    progress: 85,
    description: "本项目是对已批准的人体细胞治疗方案进行优化修正，主要针对入组条件、给药方案和随访周期进行调整，以提高治疗效果并减少不良反应。",
    aiSummary: "【跟踪报告摘要】\n• 入组进度低于预期(计划45人，已入组32人)\n• 不良反应发生率低于预期(5.2%，预期10%)\n• 初步疗效数据显示60%患者获益\n• 两例严重不良事件均已妥善处理\n\n建议：继续执行当前方案，适当扩大招募宣传范围",
    aiModelName: "EthicGPT 2024",
    aiModelVersion: "v3.1",
    aiRecommendations: "扩大受试者招募范围；优化随访流程，增加中期评估点；加强不良反应监测频率，尤其对高风险人群",
    risk: {
      level: "中",
      analysis: "细胞治疗存在免疫排斥反应风险，但通过改进的预处理方案已将发生率从原方案的12%降低至现方案的5.2%。新增的随访方案有效提高了不良反应早期发现率。",
      suggestions: [
        "完善不良反应分级管理流程",
        "对既往出现轻度反应患者加强随访频率",
        "建立实时数据监测分析机制"
    ...
    safetyData: {
      adverseEvents: 7,
      severeAdverseEvents: 2,
      adverseEventRate: 5.2,
      mostCommonEvents: ["轻度发热", "注射部位红肿", "暂时性疲劳"]
    },
    files: [
      ...
      { id: "trk5", name: "审查意见书.pdf", type: "review", size: "1.1MB", uploadedAt: "2024-05-18", status: "已生成" }
    ]
  }
];

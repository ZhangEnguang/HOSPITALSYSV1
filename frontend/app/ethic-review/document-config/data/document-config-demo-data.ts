...
const initialReviewDocuments = [
  ...
  { id: "d50", name: "伦理审查申请书", type: "申请表", requirementLevel: "必交", template: true, description: "伦理委员会审查的正式申请书" },
  { id: "d51", name: "研究团队资质证明", type: "其他", requirementLevel: "必交", template: false, description: "研究团队成员的专业资质证明文件" },
  { id: "d52", name: "研究场所证明", type: "其他", requirementLevel: "必交", template: false, description: "研究将进行的场所的适用性证明" },
  { id: "d53", name: "招募材料", type: "其他", requirementLevel: "选交", template: true, description: "用于招募受试者的广告、海报等材料" },
  { id: "d54", name: "筛选问卷", type: "调查问卷", requirementLevel: "选交", template: true, description: "用于筛选合格受试者的问卷" },
  { id: "d55", name: "研究数据收集表", type: "研究工具", requirementLevel: "必交", template: true, description: "用于收集研究数据的标准表格" },
  { id: "d56", name: "随访计划", type: "研究方案", requirementLevel: "必交", template: false, description: "受试者随访计划和时间表" },
  { id: "d57", name: "不良事件报告流程", type: "其他", requirementLevel: "必交", template: true, description: "不良事件的报告程序和流程" },
  { id: "d58", name: "数据管理计划", type: "其他", requirementLevel: "必交", template: false, description: "研究数据的管理和存储计划" },
  { id: "d59", name: "统计分析计划", type: "研究方案", requirementLevel: "必交", template: false, description: "研究数据的统计分析方法和计划" },
  { id: "d60", name: "质量控制方案", type: "其他", requirementLevel: "选交", template: false, description: "研究质量控制和保证方案" },
  { id: "d61", name: "研究监察计划", type: "其他", requirementLevel: "选交", template: false, description: "研究监察的计划和程序" },
  { id: "d62", name: "参与者补偿方案", type: "其他", requirementLevel: "必交", template: true, description: "研究参与者的补偿和报销方案" },
  { id: "d63", name: "保密协议", type: "其他", requirementLevel: "必交", template: true, description: "研究团队成员签署的保密协议" },
  { id: "d64", name: "研究药品/设备说明", type: "其他", requirementLevel: "选交", template: false, description: "研究中使用的药品或设备的详细说明" },
  { id: "d65", name: "伦理培训证明", type: "其他", requirementLevel: "必交", template: false, description: "研究人员接受伦理培训的证明" },
  { id: "d66", name: "利益冲突声明", type: "其他", requirementLevel: "必交", template: true, description: "研究者潜在利益冲突的声明" }
];
...
export const documentConfigItems = [
  {
    ...
    documents: initialReviewDocuments,
    documentCount: initialReviewDocuments.length,
    requiredCount: initialReviewDocuments.filter(doc => doc.requirementLevel === "必交").length,
    optionalCount: initialReviewDocuments.filter(doc => doc.requirementLevel === "选交").length,
    templateCount: initialReviewDocuments.filter(doc => doc.template).length,
    createdBy: users[0],
  ...
  },
  {
    ...
    requiredCount: 3,
    optionalCount: 1,
    templateCount: animalInitialDocuments.filter(doc => doc.template).length,
    createdBy: users[1],
  ...
  },
  {
    ...
    requiredCount: 4,
    optionalCount: 0,
    templateCount: amendmentReviewDocuments.filter(doc => doc.template).length,
    createdBy: users[2],
  ...
  },
  {
    ...
    requiredCount: 4,
    optionalCount: 0,
    templateCount: humanGeneticsDocuments.filter((doc, index) => index < 4 && doc.template).length,
    createdBy: users[3],
  ...
  },
  {
    ...
    requiredCount: 5,
    optionalCount: 1,
    templateCount: internationalDocuments.filter(doc => doc.template).length,
    createdBy: users[3],
...
// 配置历史记录数据
export const documentConfigHistory = [
  {
    id: "h1",
    configId: "dc1",
    version: "1.0",
    changeType: "创建",
    changeDescription: "初始创建人体初始审查文件清单",
    changedFields: [],
    documents: initialReviewDocuments.slice(0, 4),
    documentCount: 4,
    requiredCount: 4,
    optionalCount: 0,
    templateCount: 3,
  ...
  },
  {
    ...
    version: "1.1",
    changeType: "添加文件",
    changeDescription: "添加研究者简历和相关文献要求",
    changedFields: ["documents", "documentCount", "requiredCount", "optionalCount"],
    documents: initialReviewDocuments.slice(0, 6),
    documentCount: 6,
    requiredCount: 5,
    optionalCount: 1,
    templateCount: 3,
    createdBy: users[0],
    createdAt: "2024-04-18T14:25:00Z",
  },
  {
    id: "h3",
    configId: "dc1",
    version: "2.0",
    changeType: "重大更新",
    changeDescription: "全面更新审查要求，增加多项文件",
    changedFields: ["documents", "documentCount", "requiredCount", "optionalCount", "templateCount", "description"],
    documents: initialReviewDocuments.slice(0, 12),
    documentCount: 12,
    requiredCount: 9,
    optionalCount: 3,
    templateCount: 6,
  ...
  },
  {
    ...
    version: "3.0",
    changeType: "重大更新",
    changeDescription: "完善人体初始审查文件清单，增加更多必要文件",
    changedFields: ["documents", "documentCount", "requiredCount", "optionalCount", "templateCount"],
    documents: initialReviewDocuments,
    documentCount: initialReviewDocuments.length,
    requiredCount: initialReviewDocuments.filter(doc => doc.requirementLevel === "必交").length,
    optionalCount: initialReviewDocuments.filter(doc => doc.requirementLevel === "选交").length,
  ...
  },
  {
    ...
    version: "1.0",
    changeType: "创建",
    changeDescription: "初始创建动物初始审查文件清单",
    changedFields: [],
    documents: animalInitialDocuments.slice(0, 2),
    documentCount: 2,
    requiredCount: 2,
    optionalCount: 0,
    templateCount: 1,
  ...
  },
  {
    ...
    version: "1.1",
    changeType: "添加文件",
    changeDescription: "添加动物设施资质证明",
    changedFields: ["documents", "documentCount", "optionalCount"],
    documents: animalInitialDocuments,
    documentCount: animalInitialDocuments.length,
    requiredCount: animalInitialDocuments.filter(doc => doc.requirementLevel === "必交").length,
    optionalCount: animalInitialDocuments.filter(doc => doc.requirementLevel === "选交").length,
    templateCount: animalInitialDocuments.filter(doc => doc.template).length,
    createdBy: users[1],
  ...
  },
  {
    ...
    version: "1.0",
    changeType: "创建",
    changeDescription: "初始创建修正案审查文件清单",
    changedFields: [],
    documents: amendmentReviewDocuments.slice(0, 2),
    documentCount: 2,
    requiredCount: 2,
    optionalCount: 0,
    templateCount: 1,
  ...
  },
  {
    ...
    version: "1.1",
    changeType: "添加文件",
    changeDescription: "补充原批准文件",
    changedFields: ["documents", "documentCount"],
    documents: amendmentReviewDocuments,
    documentCount: amendmentReviewDocuments.length,
    requiredCount: amendmentReviewDocuments.filter(doc => doc.requirementLevel === "必交").length,
    optionalCount: amendmentReviewDocuments.filter(doc => doc.requirementLevel === "选交").length,
    templateCount: amendmentReviewDocuments.filter(doc => doc.template).length,
    createdBy: users[2],
  ...
  },
  {
    ...
    version: "1.0",
    changeType: "创建",
    changeDescription: "初始创建人遗采集审批文件清单",
    changedFields: [],
    documents: humanGeneticsDocuments.slice(0, 2),
    documentCount: 2,
    requiredCount: 2,
    optionalCount: 0,
    templateCount: 1,
  ...
  },
  {
    ...
    version: "1.1",
    changeType: "添加文件",
    changeDescription: "补充伦理审查批件",
    changedFields: ["documents", "documentCount"],
    documents: humanGeneticsDocuments.filter((_, idx) => idx < 4),
    documentCount: 4,
    requiredCount: 4,
    optionalCount: 0,
    templateCount: humanGeneticsDocuments.filter((doc, idx) => idx < 4 && doc.template).length,
    createdBy: users[3],
  ...
  },
  {
    ...
    version: "1.0",
    changeType: "创建",
    changeDescription: "初始创建国际合作科学研究审批文件清单",
    changedFields: [],
    documents: internationalDocuments.slice(0, 3),
    documentCount: 3,
    requiredCount: 3,
    optionalCount: 0,
    templateCount: 1,
  ...
  },
  {
    ...
    version: "1.1",
    changeType: "添加文件",
    changeDescription: "补充数据安全保障措施",
    changedFields: ["documents", "documentCount"],
    documents: internationalDocuments,
    documentCount: internationalDocuments.length,
    requiredCount: internationalDocuments.filter(doc => doc.requirementLevel === "必交").length,
    optionalCount: internationalDocuments.filter(doc => doc.requirementLevel === "选交").length,
    templateCount: internationalDocuments.filter(doc => doc.template).length,
    createdBy: users[3],
  ...
  },
  {
    ...
    version: "1.0",
    changeType: "创建",
    changeDescription: "初始创建安全性审查文件清单",
    changedFields: [],
    documents: safetyReviewDocuments.slice(0, 2),
    documentCount: 2,
    requiredCount: 2,
    optionalCount: 0,
    templateCount: 1,
  ...
  },
  {
    ...
    version: "1.1",
    changeType: "添加文件",
    changeDescription: "补充风险评估报告",
    changedFields: ["documents", "documentCount", "optionalCount"],
    documents: safetyReviewDocuments,
    documentCount: safetyReviewDocuments.length,
    requiredCount: safetyReviewDocuments.filter(doc => doc.requirementLevel === "必交").length,
    optionalCount: safetyReviewDocuments.filter(doc => doc.requirementLevel === "选交").length,
    templateCount: safetyReviewDocuments.filter(doc => doc.template).length,
    createdBy: users[4],
  ...
  },
  {
    ...
    version: "1.0",
    changeType: "创建",
    changeDescription: "初始创建年度/定期审查文件清单",
    changedFields: [],
    documents: annualReviewDocuments.slice(0, 2),
    documentCount: 2,
    requiredCount: 2,
    optionalCount: 0,
    templateCount: 1,
  ...
  },
  {
    ...
    version: "1.1",
    changeType: "添加文件",
    changeDescription: "补充知情同意执行情况",
    changedFields: ["documents", "documentCount"],
    documents: annualReviewDocuments,
    documentCount: annualReviewDocuments.length,
    requiredCount: annualReviewDocuments.filter(doc => doc.requirementLevel === "必交").length,
    optionalCount: annualReviewDocuments.filter(doc => doc.requirementLevel === "选交").length,
    templateCount: annualReviewDocuments.filter(doc => doc.template).length,
    createdBy: users[0],

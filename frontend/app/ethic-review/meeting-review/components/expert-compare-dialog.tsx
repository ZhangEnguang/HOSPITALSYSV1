    ...
    <TooltipProvider>
      <Dialog open={isOpen} onOpenChange={onClose}>
        ...
        <DialogHeader className="flex-shrink-0">
          <DialogTitle className="flex items-center" style={{fontSize: '18px'}}>
                ...
                <CardHeader>
                  <CardTitle className="text-base flex items-center justify-between">
                    <div className="flex items-center">
                      <GitCompare className="h-4 w-4 mr-2 text-blue-600" />
                      专家评价对比分析
                    </div>
                    <div className="text-xs text-gray-500">
                      共 {expertOpinions.length} 位专家参与评审 • {allCriteria.length} 项标准
                    </div>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      <div className="flex items-center mb-3">
                        ...
                        <span className="font-medium text-gray-800" style={{fontSize: '16px'}}>评审结果分布</span>
                      </div>
                    ...
                    <div>
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="font-medium text-gray-800" style={{fontSize: '16px'}}>评审标准一致性分布</span>
                          </div>
                  ...
                  {/* 下方：AI智能解读 */}
                  <div className="bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 border border-gray-200 rounded-lg p-6 shadow-sm mt-6">

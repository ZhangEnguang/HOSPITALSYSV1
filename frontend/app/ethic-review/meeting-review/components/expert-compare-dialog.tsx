                ...
                <CardHeader>
                  <CardTitle className="text-base flex items-center justify-between">
                    ...
                    <div className="text-xs text-gray-500">
                      共 {expertOpinions.length} 位专家参与评审
                    </div>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col justify-center">
                      <div className="bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 border border-gray-200 rounded-lg p-4 shadow-sm">
                        <div className="flex items-center mb-3">
                          ...
                          <span className="font-medium text-blue-900">AI智能解读</span>
                          <div className="ml-auto">
                            <span className="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded-full">智能分析</span>
                          </div>
                        </div>
                              ...
                              return (
                                <>
                                  <div className="text-sm text-blue-800 leading-relaxed">
                                    ...
                                    <div>基于对{total}位专家评审意见的深度分析，该CRISPR基因检测项目获得了专家的高度认可。{agreeCount}位专家完全同意项目实施，认为研究设计科学、技术路线可行。</div>
                                  </div>
                                </>
                              );
                            } else if (supportRate >= 0.7) {
                              return (
                                <>
                                  <div className="text-sm text-blue-800 leading-relaxed">
                                    <div className="flex items-center font-medium mb-2">
                                    ...
                                    <div>通过对{total}位专家评审意见的智能分析，项目整体获得积极评价。{agreeCount}位专家同意，{modifyCount}位专家建议修改后同意，主要关注点集中在数据保护和技术应用边界。</div>
                                  </div>
                                </>
                              );
                              ...
                              return (
                                <>
                                  <div className="text-sm text-blue-800 leading-relaxed">
                                    ...
                                    <div>AI分析发现项目存在复杂的技术和伦理争议。{transferCount}位专家建议提交会议讨论，主要原因是CRISPR技术在儿童群体中的应用涉及多个专业领域的交叉评估。</div>
                                  </div>
                                </>
                              );
                            } else {
                              return (
                                <>
                                  <div className="text-sm text-blue-800 leading-relaxed">
                                    ...
                                    <div>AI分析显示专家意见存在较大分歧，{disagreeCount}位专家不同意项目实施，主要担忧集中在技术风险和伦理合规性方面。</div>
                                  </div>
                                </>
                              );
                            }
                          ...
                          <div>
                            {(() => {
                              ...
                              if (consensusRate >= 0.8) {
                                return "专家在评审标准上高度一致，决策依据充分可靠，建议优先处理。";
                              } else if (consensusRate >= 0.6) {
                                return "专家在多数标准上达成共识，存在部分分歧点需要重点关注和讨论。";
                              } else {
                                return "专家意见分歧较大，建议深入分析分歧原因，必要时召开专家会议讨论。";
                              }
                            })()}
                          </div>
                        </div>

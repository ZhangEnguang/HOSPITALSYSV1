...
// 人遗采集审批编辑页面内容组件
function EditCollectionReviewPageContent() {
  ...
  // 人遗采集审批送审文件清单 - 带有演示数据
  const collectionReviewFiles: CustomReviewFileItem[] = [
    {
      id: 1,
      fileName: "人类遗传资源采集申请表",
      format: "PDF/Word",
      required: true,
      quantity: "1",
      fileType: "申请表",
      ...
      versionNumber: "V1.3",
      hasTemplate: true,
      templateUrl: "/templates/genetic-collection-application.docx"
    },
    {
      id: 2,
      fileName: "采集方案",
      ...
      versionNumber: "V2.1",
      hasTemplate: true,
      templateUrl: "/templates/collection-protocol.docx"
    },
    {
      id: 3,
      fileName: "知情同意书",
    ...
    },
    {
      ...
      versionNumber: "V1.2",
      hasTemplate: true,
      templateUrl: "/templates/sample-preservation-plan.docx"
    },
    {
      id: 8,
      fileName: "其他支持性文件",
  ...
  // 管理送审文件清单状态
  const [reviewFiles, setReviewFiles] = useState<CustomReviewFileItem[]>(collectionReviewFiles)

  // 处理表单提交
  const handleSubmit = (data: any) => {
    console.log("提交人遗采集审批表单:", data)
    toast({
      title: "提交成功",
      description: "人遗采集审批表单已提交成功"
    })
...
// 人遗采集审批编辑页面
export default function EditCollectionReviewPage() {
  return (
    <Suspense fallback={
      <div className="p-8 flex flex-col items-center justify-center">
        <div className="mb-4">
      ...
      <EditCollectionReviewPageContent />
    </Suspense>
  )
} 
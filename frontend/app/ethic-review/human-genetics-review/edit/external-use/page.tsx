...
// 对外提供使用备案编辑页面
function EditExternalUseReviewPageContent() {
  ...
  // 对外提供使用备案送审文件清单 - 带有演示数据
  const externalUseReviewFiles: CustomReviewFileItem[] = [
    {
      id: 1,
      fileName: "人类遗传资源对外提供或开放使用备案表",
      format: "PDF/Word",
      required: true,
      quantity: "1",
      fileType: "申请表",
      ...
      versionNumber: "V1.2",
      hasTemplate: true,
      templateUrl: "/templates/external-use-filing-form.docx"
    },
    {
      id: 2,
      fileName: "对外提供或开放使用说明",
      format: "PDF/Word",
      required: true,
      quantity: "1",
      fileType: "使用说明",
      ...
      versionNumber: "V2.0",
      hasTemplate: true,
      templateUrl: "/templates/external-use-explanation.docx"
    },
    {
      id: 3,
      fileName: "资源详细清单",
      ...
      versionNumber: "V1.1",
      hasTemplate: true,
      templateUrl: "/templates/genetic-resource-list.xlsx"
    },
    {
      id: 4,
      fileName: "使用方资质证明",
    ...
    },
    {
      ...
      versionNumber: "V1.3",
      hasTemplate: true,
      templateUrl: "/templates/external-use-agreement.docx"
    },
    {
      id: 6,
      fileName: "伦理审查通过证明",
  ...
  // 管理送审文件清单状态
  const [reviewFiles, setReviewFiles] = useState<CustomReviewFileItem[]>(externalUseReviewFiles)

  // 处理表单提交
  const handleSubmit = (data: any) => {
    console.log("提交对外提供使用备案表单:", data)
    toast({
      title: "提交成功",
      description: "对外提供使用备案表单已提交成功"
    })
...
// 对外提供使用备案编辑页面
export default function EditExternalUseReviewPage() {
  return (
    <Suspense fallback={
      <div className="p-8 flex flex-col items-center justify-center">
        <div className="mb-4">
      ...
      <EditExternalUseReviewPageContent />
    </Suspense>
  )
} 
...
// 国际合作临床试验编辑页面
function EditInternationalClinicalReviewPageContent() {
  ...
  // 国际合作临床试验送审文件清单 - 带有演示数据
  const internationalClinicalReviewFiles: CustomReviewFileItem[] = [
    {
      id: 1,
      fileName: "国际合作临床试验备案申请表",
      format: "PDF/Word",
      required: true,
      quantity: "1",
      fileType: "申请表",
      ...
      versionNumber: "V1.3",
      hasTemplate: true,
      templateUrl: "/templates/international-clinical-trial-filing-form.docx"
    },
    {
      id: 2,
      fileName: "临床试验方案",
      ...
      versionNumber: "V2.2",
      hasTemplate: true,
      templateUrl: "/templates/clinical-trial-protocol.docx"
    },
    {
      id: 3,
      fileName: "国际合作协议",
      ...
      versionNumber: "V1.0",
      hasTemplate: true,
      templateUrl: "/templates/international-cooperation-agreement.docx"
    },
    {
      id: 4,
      fileName: "合作方资质证明",
    ...
    },
    {
      ...
      versionNumber: "V1.4",
      hasTemplate: true,
      templateUrl: "/templates/subject-informed-consent.docx"
    },
    {
      id: 6,
      fileName: "伦理审查通过证明",
    ...
    },
    {
      ...
      versionNumber: "V2.0",
      hasTemplate: true,
      templateUrl: "/templates/drug-device-description.docx"
    },
    {
      id: 8,
      fileName: "研究者手册",
  ...
  // 管理送审文件清单状态
  const [reviewFiles, setReviewFiles] = useState<CustomReviewFileItem[]>(internationalClinicalReviewFiles)

  // 处理表单提交
  const handleSubmit = (data: any) => {
    console.log("提交国际合作临床试验备案表单:", data)
    toast({
      title: "提交成功",
      description: "国际合作临床试验备案表单已提交成功"
    })
...
// 国际合作临床试验编辑页面
export default function EditInternationalClinicalReviewPage() {
  return (
    <Suspense fallback={
      <div className="p-8 flex flex-col items-center justify-center">
        <div className="mb-4">
      ...
      <EditInternationalClinicalReviewPageContent />
    </Suspense>
  )
} 
...
interface AcademicPaperRelatedProjectsTabProps {
  data: any
}

export default function AcademicPaperRelatedProjectsTab({ data }: AcademicPaperRelatedProjectsTabProps) {
  // 项目状态映射
  ...
  const projectData = {
    ...
    members: 8,
    description: "本项目旨在研究智慧园区综合管理平台的关键技术，解决园区管理中的信息孤岛、管理效率低下等问题，提出新的管理模式和技术方案，并在实际园区中进行应用验证。"
  }
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-md p-3 mt-4">
              <div className="flex items-start">
                ...
                <p className="text-sm text-blue-700">
                  <span className="font-medium">成果贡献：</span> 本论文是项目"{projectData.name}"的重要研究成果之一，为项目的顺利实施和目标达成提供了重要的理论支持和技术指导。
                </p>
              </div>
            </div>
          </div>

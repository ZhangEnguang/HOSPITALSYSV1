...
export default function PatentAuditPage({ params }: { params: { id: string } }) {
        ...
        <div className="flex-1 pr-[350px]"> {/* 为右侧审核面板留出空间 */}
          ...
          {patent.description && (
            <div className="mt-4 p-4 bg-slate-50 rounded-lg">
              <h3 className="text-sm font-medium text-slate-900 mb-2">专利简介</h3>
              <p className="text-sm text-slate-700 whitespace-pre-line">{patent.description}</p>
            </div>
          )}
        </div>

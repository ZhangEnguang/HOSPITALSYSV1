...
interface AchievementAwardRelatedProjectsTabProps {
  data: any
}

export default function AchievementAwardRelatedProjectsTab({ data }: AchievementAwardRelatedProjectsTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-lg font-semibold">项目成果统计</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-slate-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-slate-500">学术论文</div>
            ...
            <div className="p-4 bg-slate-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-slate-500">学术著作</div>
            ...
            <div className="p-4 bg-slate-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-slate-500">成果获奖</div>
          ...
          <div className="mt-6">
            <h4 className="text-sm font-medium text-slate-700 mb-3">成果分布</h4>

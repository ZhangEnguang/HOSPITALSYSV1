...
export default function MobileMenu({ open, onOpenChange }: MobileMenuProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { name: "初始审查", icon: <ClipboardCheck className="h-5 w-5" />, path: "/ethic-review/initial-review" },
    { name: "跟踪报告", icon: <ClipboardCheck className="h-5 w-5" />, path: "/ethic-review/track-review" },
    { name: "人遗资源", icon: <ClipboardCheck className="h-5 w-5" />, path: "/ethic-review/human-genetics-review" },

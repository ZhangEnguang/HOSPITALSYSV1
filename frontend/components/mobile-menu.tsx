...
export default function MobileMenu({ open, onOpenChange }: MobileMenuProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { name: "跟踪审查", icon: <ClipboardCheck className="h-5 w-5" />, path: "/ethic-review/track-review" },
    { name: "人遗审查", icon: <ClipboardCheck className="h-5 w-5" />, path: "/ethic-review/human-genetics-review" },
